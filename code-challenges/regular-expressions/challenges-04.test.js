...
const isCapitalized = (str) => {
  ...
  let firstCaptial = str.match(capital);
  if (firstCaptial !== null){
    return firstCaptial;
  } else {
      return [];
    }
...
const noPunctuation = str => {
  // Solution code here...
  let punctuation = /\b\w*(?: )/g;
  let myemptyArray = [];
  myemptyArray = str.match(punctuation);
  if (punctuation !== null){
    return myemptyArray;
  } 
