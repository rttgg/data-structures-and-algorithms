...
const sortNumbersByLength = (arr) => {
  return arr.sort(numberLength);
};

const numberLength = (a, b) => {
...
const sortPeople = (arr) => {
  return arr.sort(peopleLastName);
};

const peopleLastName= (a, b) => {
